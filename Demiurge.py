...
# Executing main body of the script
if __name__ == "__main__":
    
    parser = argparse.ArgumentParser(description="Complex software to create NMR-based ML inputs from SMILES")
    parser.add_argument("--csv_path", type=str, help="Path to the input CSV file with SMILES.")
    parser.add_argument("--predictor", type=str, help="Choose 1H or 13C NMR Predictor.")
    parser.add_argument("--label_column", type=int, help="Specify column in input file in which labels are present.")
...
'''
# Cleaning and removing temporary dirs and data
    temp_data = [mol_directory, csv_output_folder, processed_dir]
